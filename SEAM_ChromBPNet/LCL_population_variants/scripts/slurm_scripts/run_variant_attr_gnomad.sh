...
#SBATCH --array=0-33
#SBATCH --job-name=varattr_gnomad
...
#
# DeepSHAP attributions on gnomAD variant library. Requires GPU.
#
# Usage:
#   sbatch run_variant_attr_gnomad.sh
...
echo "=============================================="
echo "Variant Attributions: gnomAD"
...
python3 "$SCRIPT_DIR/run_seam_pipeline.py" --step attribute --source gnomad --locus "$LOCUS"

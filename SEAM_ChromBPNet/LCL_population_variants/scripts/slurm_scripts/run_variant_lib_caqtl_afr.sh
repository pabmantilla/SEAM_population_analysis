...
#SBATCH --time=4:00:00
#SBATCH --array=0-33
#SBATCH --job-name=varlib_caqtl_afr
...
#
# Variant-only library (African caQTL) per locus. CPU only.
#
# Usage:
#   sbatch run_variant_lib_caqtl_afr.sh
...
echo "=============================================="
echo "Variant Library: caQTL African"
...
python3 "$SCRIPT_DIR/make_variant_library.py" --source caqtl_afr --locus "$LOCUS"

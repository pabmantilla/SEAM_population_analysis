...
#SBATCH --time=4:00:00
#SBATCH --array=0-33
#SBATCH --job-name=varlib_caqtl_eur
...
#
# Variant-only library (European caQTL) per locus. CPU only.
#
# Usage:
#   sbatch run_variant_lib_caqtl_eur.sh
...
echo "=============================================="
echo "Variant Library: caQTL European"
...
python3 "$SCRIPT_DIR/make_variant_library.py" --source caqtl_eur --locus "$LOCUS"

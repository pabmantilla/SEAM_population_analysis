...
#SBATCH --array=0-33
#SBATCH --job-name=varattr_caqtl_afr
...
#
# DeepSHAP attributions on African caQTL variant library. Requires GPU.
#
# Usage:
#   sbatch run_variant_attr_caqtl_afr.sh
...
echo "=============================================="
echo "Variant Attributions: caQTL African"
...
python3 "$SCRIPT_DIR/run_seam_pipeline.py" --step attribute --source caqtl_afr --locus "$LOCUS"

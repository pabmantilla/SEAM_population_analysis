...
#SBATCH --array=0-33
#SBATCH --job-name=varattr_caqtl_eur
...
#
# DeepSHAP attributions on European caQTL variant library. Requires GPU.
#
# Usage:
#   sbatch run_variant_attr_caqtl_eur.sh
...
echo "=============================================="
echo "Variant Attributions: caQTL European"
...
python3 "$SCRIPT_DIR/run_seam_pipeline.py" --step attribute --source caqtl_eur --locus "$LOCUS"
